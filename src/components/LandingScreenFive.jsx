  ...
  return (
    <div className='w-11/12 lg:w-8/12 mx-auto'>
      <div className='w-full flex flex-col items-center justify-center'>
        <div className='flex lg:flex-row flex-col justify-between items-center w-full my-10'>
        ...
        <h2 className='text-center lg:text-left text-2xl lg:text-4xl font-light text-white'>
          SPA is the value accrual and governance token
        </h2>
        <div className='text-center lg:text-left text-lg lg:text-2xl text-white'>
          <span>for the </span>
          <span className='text-cyan-500'>Sperax ecosystem</span>
        </div>
        <div className='grid lg:grid-cols-3 grid-cols-1 lg:w-full w-10/12 gap-5 mt-10'>
        ...
        <button className='w-1/2 lg:w-48 bg-cyan-500 rounded-full h-14 font-semibold text-white hover:bg-cyan-700 hover:text-gray-300 hover:cursor-pointer mt-10'>Get SPA Token</button>
      </div>
    </div>
  );
}
