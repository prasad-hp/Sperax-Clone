    ...
    <div className='w-8/12'>
        <div className='w-full flex flex-col items-center justify-center'>
            <div className='flex lg:flex-row flex-col justify-between items-center w-full my-10'>
                <div className='lg:w-1/2 w-10/12 lg:flex lg:flex-col lg:items-start'>
                    <h3 className='text-white font-light text-xl'>Total Supply</h3>
                    <div className='flex justify-center lg:items-center space-x-1 text-7xl font-medium'>
                        <h1 className='text-white'>4.590 B</h1>
                        <h1 className='text-gray-400'>SPA</h1>
                    </div>
                </div>
                <div className='lg:w-1/2 w-10/12 flex justify-end items-center'>
