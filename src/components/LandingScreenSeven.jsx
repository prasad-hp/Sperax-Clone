  ...
  return (
    <div className='w-8/12'>
        <div className='flex items-center justify-center flex-col'>
            <div className='bg-[url("../../spartan_bg.svg")] w-full flex items-center flex-col justify-center'>
                <img src="../../Macot.svg" alt="Macot" />
            </div>
            <h1 className='text-7xl text-white font-sans font-semibold text-center p-10 w-3/4'>Join the SPArtan army!!</h1>
            <div className='flex items-center justify-around w-full space-x-5 mt-10'>
            ...
            <h2 className='text-white text-5xl font-semibold font-sans mt-36'>Keep up with Sperax</h2>
            <h4 className='text-white text-xl w-1/3 text-center mt-5'>Latest Substack posts with all recent developments and updates</h4>
            <form className='m-5'>
            ...
            <div className='w-full flex items-start justify-between space-x-3 py-5'>
            ...
            <div className='w-full flex flex-col items-center justify-center pt-28 text-white font-sans'>
                ...
                <h3 className='text-2xl py-2'>Audited & Verified</h3>
                <h1 className='text-5xl font-semibold pt-2 pb-5'>The most secure protocol for money</h1>
                <div className='flex items-center justify-center w-full px-10 py-10 space-x-4'>
            ...
            <div className='bg-white rounded-3xl h-52 w-full text-center flex items-center flex-col justify-center'>
