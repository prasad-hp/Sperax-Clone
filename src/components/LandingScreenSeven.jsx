...
function LandingScreenSeven() {
  return (
    <div className='w-screen flex items-center justify-center flex-col'>
                <div className='bg-[url("../../spartan_bg.svg")] bg-top bg-cover bg-origin-content bg-no-repeat lg:w-10/12 w-full lg:flex hidden items-center flex-col justify-center'>
        ...
        <div className='lg:w-8/12 w-11/12'>
            <div className='flex items-center justify-center flex-col'>
                ...
                <div className='flex justify-center items-center w-full mt-10'>
                    <div className='grid lg:grid-cols-4 lg:grid-rows-1 grid-rows-2 gap-4 grid-cols-2'>
                ...
                <form className='m-5 lg:flex-row flex flex-col justify-center items-center'>
                    <input type="text" placeholder='Enter your Email' className='rounded-full bg-new-cement h-10 pl-3 lg:w-80 md:w-1/2 w-3/4'/>
                    <input type="submit" className='text-sm font-semibold rounded-full bg-new-blue w-28 h-10 m-2 text-white'/>
                </form>
                ...
                <button className="bg-transparent hover:text-cyan-400 duration-150 my-10 text-white text-sm py-2 px-4 h-12 w-32 rounded-full border-new-blue border">View All →</button>
                <div className='w-full flex flex-col items-center justify-center pt-28 text-white font-sans'>
                    ...
                    <button className="bg-transparent hover:text-cyan-400 duration-150 my-10 text-white text-sm py-2 px-4 h-12 w-32 rounded-full border-new-blue border">View Reports </button>
                </div>
                <div className='bg-white rounded-3xl lg:h-52 w-full text-center flex items-center flex-col justify-center'>
                    ...
                    <div className='flex lg:flex-row flex-col space-y-6 justify-center items-center space-x-8 py-5'>
