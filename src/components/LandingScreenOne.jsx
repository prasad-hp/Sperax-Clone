...
function LandingScreenOne() {
  return (
      <div className='lg:w-8/12 md:w-10/12 w-11/12 md:flex overflow-visible'>
        ...
        <section className='md:w-1/2 w-full bg-[url("")] overflow-visible'>
            <div className='w-full md:hidden text-white mt-10 flex flex-col items-center'>
                ...
                <button className='bg-transparent border border-new-blue text-white rounded-full h-14 w-3/4 mt-2'>Get USDs→</button>
            </div>
