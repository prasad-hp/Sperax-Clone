  ...
  return (
        <div className='lg:w-8/12 md:w-10/12 w-11/12'>
            <div className='flex flex-col justify-center items-center text-center'>
                <div className='text-white font-semibold font-sans md:text-5xl text-3xl text-center py-20'>Unleash the Power of 
                    <div className='flex'>
                ...
                <section className='flex lg:flex-row flex-col lg:justify-between lg:items-center items-start space-x-20'>
                    <div className='lg:w-1/3 m-0 md:w-2/3 w-full flex text-left flex-col justify-start items-start'>
                    ...
                    <div className='lg:w-1/3 md:w-2/3 m-0 w-full flex text-left flex-col justify-start items-start'>
                        <div className='bg-gray-900 rounded-full w-20'>
